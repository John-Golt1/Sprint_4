...
public class SamokatTest {
    ...
    public void checkTextSamocatText0() {
        MainSamokat objTextButton = new MainSamokat(driver);
        assertEquals("Not correct text",textQuest1, objTextButton.questionBut0());
    }
    @Test //проверяем текст во второй кнопке
    public void checkTextSamocatText1() {
        MainSamokat objTextButton = new MainSamokat(driver);
        assertEquals("Not correct text",textQuest2, objTextButton.questionBut1());
    }
    @Test  //проверяем текст в третьей кнопке
    public void checkTextSamocatText2() {
        MainSamokat objTextButton = new MainSamokat(driver);
        assertEquals("Not correct text",textQuest3, objTextButton.questionBut2());
    }
    @Test  //проверяем текст в четвертой кнопке
    public void checkTextSamocatText3() {
        MainSamokat objTextButton = new MainSamokat(driver);
        assertEquals("Not correct text",textQuest4, objTextButton.questionBut3());
    }
    @Test  //проверяем текст в пятой кнопке
    public void checkTextSamocatText4() {
        MainSamokat objTextButton = new MainSamokat(driver);
        assertEquals("Not correct text",textQuest5, objTextButton.questionBut4());
    }
    @Test  //проверяем текст в шестой кнопке
    public void checkTextSamocatText5() {
        MainSamokat objTextButton = new MainSamokat(driver);
        assertEquals("Not correct text",textQuest6, objTextButton.questionBut5());
    }
    @Test  //проверяем текст в седьмой кнопке
    public void checkTextSamocatText6() {
        MainSamokat objTextButton = new MainSamokat(driver);
        assertEquals("Not correct text",textQuest7, objTextButton.questionBut6());
    }
    @Test  //проверяем текст в восьмой кнопке
    public void checkTextSamocatText7() {
        MainSamokat objTextButton = new MainSamokat(driver);
        assertEquals("Not correct text",textQuest8, objTextButton.questionBut7());
    }
